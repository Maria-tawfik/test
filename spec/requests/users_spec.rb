...
RSpec.describe "Users", :type => :request do
  ...
  describe "profile page" do
    ...
    describe "follow/unfollow buttons" do
      ...
      describe "following a user" do
        ...
        it "should incre the followed user count" do
          expect do
            click_button "Follow"
          end.to change (user.followed_users,:count).by(1)
        end
        it"should incre the other user followers" do
          expect do
            click_button "Follow"
      ...
      describe "unfollowing a user" do
        ...
        it "should decre the followed user count" do
          expect do
            click_button "Unfollow"
          end.to change(user.followed_users, :count).by(-1)
        end  

        it "should decre the other user's followers count" do
          expect do
            click_button "Unfollow"
          end.to change(other_user.followers, :count).by(-1)
        end
  ...
  describe "following/followers" do
    ...
    describe"followed users (following)" do
      before do
        sign_in user
        viisit following_user_psth(user)
      end
